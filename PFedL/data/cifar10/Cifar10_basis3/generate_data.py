...
def main(n_basis):
    ...
    for label in range(n_classes):
        if label in animal2_index:
            split_trainclass_idx.append(data_split(trainclass_idx[label], 6))
            split_testclass_idx.append(data_split(testclass_idx[label], 6))
        else:
            split_trainclass_idx.append(data_split(trainclass_idx[label], 7))
            split_testclass_idx.append(data_split(testclass_idx[label], 7))
